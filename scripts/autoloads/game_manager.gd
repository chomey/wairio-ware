...
func _ready() -> void:
	...
	register_minigame("Snake Grow", "res://scenes/minigames/snake_grow.tscn")
	register_minigame("Tornado Dodge", "res://scenes/minigames/tornado_dodge.tscn")
	...
	register_minigame("Bumper Cars", "res://scenes/minigames/bumper_cars.tscn")
	register_minigame("Flip Memory", "res://scenes/minigames/flip_memory.tscn")
	register_minigame("Firewalk", "res://scenes/minigames/firewalk.tscn")
	register_minigame("Rocket Launch", "res://scenes/minigames/rocket_launch.tscn")
	register_minigame("Frequency Match", "res://scenes/minigames/frequency_match.tscn")
	register_minigame("Symbol Match", "res://scenes/minigames/symbol_match.tscn")
	register_minigame("Capital Quiz", "res://scenes/minigames/capital_quiz.tscn")
